...
public static class RailEndpoints
{
    ...
    public static string CreateBooking = "/create-booking";
    public static string IssueTicket = "/issue-ticket";
    public static string ConfirmBooking = "/confirm-booking";
    public static string Rail = "api/rail";
}
...
public static class ShareEndpoints
{
    ...
    public static string Commission = "api/commission";
    public static string Agent = "api/agent";
